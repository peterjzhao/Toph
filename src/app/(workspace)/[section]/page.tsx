...
const titles: Record<string,string> = { "activity-logs":"Activity Logs", map:"Map", "audit-manager":"Audit Manager", reports:"Reports", schedule:"Schedule", employees:"Employees", performance:"Performance", messages:"Messages", settings:"Settings", support:"Support", "switch-user":"Switch User", login:"Sign in" };
